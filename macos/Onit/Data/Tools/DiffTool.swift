...
class DiffTool: ToolProtocol {
    ...
    func generatePlainTextDiff(toolName: String, arguments: String) async -> Result<ToolCallResult, ToolCallError> {
        do {
            ...
            return .success(ToolCallResult(toolName: toolName, result: resultString, isComplete: true))
        } catch {
            return .failure(
                ToolCallError(
                    toolName: toolName,
