...
struct CustomProvidersSection: View {
    ...
    var title: some View {
        HStack {
            Text(String.localized("Other providers / private models", table: "Models"))
                .font(.system(size: 13))
            ...
            Button {
                ...
                Text(String.localized("Add new", table: "Models"))
            }
    ...
    var caption: some View {
        Text(String.localized("Manually add remote models from other providers.", table: "Models"))
