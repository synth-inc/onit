    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            HStack(alignment: .top) {
                Text(String.localized("Remove added models", table: "Models"))
                    .styleText(size: 13)
                    .truncateText()
                ...
                SimpleButton(
                    text: selectedAll ? String.localized("Unselect All", table: "Models") : String.localized("Select All", table: "Models"),
                    action: {
                        if selectedAll {
            ...
            HStack(alignment: .center, spacing: 8) {
                ...
                SimpleButton(
                    text: String.localized("Remove Selected", table: "Models"),
                    textColor: Color.red,
                    action: {
