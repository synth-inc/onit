...
struct ContextView: View {
            ...
            VStack(alignment: .leading) {
                ...
                if !hasError {
                    if let text = text {
                        ...
                        ProgressView(String.localized("Loading context from %@...", table: "Sidekick", readableTitle))
                            .controlSize(.small)
                    }
                }
            }
    ...
    private func getDialogInfo() -> (String, String) {
        switch context {
        case .auto(_):
            return (String.localized("AutoContext", table: "Sidekick"), String.localized("AutoContext is collected as plain text from your current window. You can manage your AutoContext preferences in settings.", table: "Sidekick"))
        case .web(let websiteUrl, _, _):
            return (String.localized("Web Context", table: "Sidekick"), String.localized("Displaying content retrieved from %@.", table: "Sidekick", websiteUrl.absoluteString))
        default:
            return (String.localized("Context", table: "Sidekick"), "")
        }
    }
    ...
    private var errorTitle: String {
        ...
        return String.localized("Error", table: "Sidekick")
    }
    ...
    private func getErrorDialogInfo() -> (String, String) {
        switch errorCode {
        case "1500":
            return (String.localized("To fetch your Google Drive tabs as window context, you'll need to connect your account. Please authenticate with Google Drive and try again.", table: "Sidekick"), String.localized("Connect Google Drive", table: "Sidekick"))
        case "1501":
            return (String.localized("Give permission to Onit to view this drive file.", table: "Sidekick"), String.localized("Grant Permission", table: "Sidekick"))
        case "1800":
            return (String.localized("A significant amount of content may be missing from your context. This can affect accuracy.", table: "Sidekick"), String.localized("View Report", table: "Sidekick"))
        default:
            return (String.localized("An error occurred while fetching context.", table: "Sidekick"), String.localized("OK", table: "Sidekick"))
        }
    }
