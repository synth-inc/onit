        ...
        VStack(alignment: .leading, spacing: 8) {
            VStack {
                ...
                if isEditing {
                    HStack {
                        Spacer()
                        Button(String.localized("Cancel", table: "Sidekick")) {
                            isEditing = false
                        ...
                        Button(String.localized("Send", table: "Sidekick")) {
                            // Handle send action
                            isEditing = false
            ...
            if windowState?.isSearchingWeb[prompt.id] ?? false {
                HStack {
                    ...
                    Text(String.localized("Searching the web", table: "Sidekick"))
                        .appFont(.medium16)
                        .foregroundColor(Color.S_2)
                    Spacer()
                }
                ...
                Button {
                    ...
                    HStack(alignment: .center) {
                        ...
                        Text(String.localized("Final context used", table: "Sidekick"))
                            .appFont(.medium13)
                        Image(.smallChevDown)
                            .renderingMode(.template)
