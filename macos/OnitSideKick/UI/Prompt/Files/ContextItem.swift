...
struct ContextItem: View {
        ...
        HStack(spacing: 0) {
            ...
            case .auto(let autoContext):
                ContextTag(
                    ...
                    tooltip: isEditing ? name : String.localized("View auto-context file", table: "Sidekick"),
            ...
            default:
                ContextTag(
                    ...
                    tooltip: isEditing ? name : String.localized("View %@ file", table: "Sidekick", item.fileType ?? ""),
                    action: showContextWindow,
                    removeAction: isEditing ? { removeContextItem() } : nil
                )
            }
    ...
    var name: String {
        ...
        case .tooBig:
            return String.localized("Upload exceeds model limit", table: "Sidekick")
