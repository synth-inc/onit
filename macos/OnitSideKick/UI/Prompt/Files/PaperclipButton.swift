    ...
    var body: some View {
        HStack(spacing: 4) {
            IconButton(
                ...
                tooltipPrompt: accessibilityAutoContextEnabled ? String.localized("Add context", table: "Sidekick") : String.localized("Upload file", table: "Sidekick")
            ) {
            ...
            if !autoContextFromCurrentWindow {
                Button {
                    ...
                    Text(String.localized("Add context", table: "Sidekick"))
                        .styleText(
                            size: 13,
                            weight: .medium,
                            color: Color.S_2
