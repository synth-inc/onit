    ...
    private var footer: some View {
        VStack(alignment: .center, spacing: spacingBetweenSections) {
            ...
            VStack(alignment: .center, spacing: 4) {
                ...
                if showApiCta {
                    HStack(spacing: 4) {
                        captionText(String.localized("Or, add your API key in", table: "Sidekick"))

                        Button {
                            openModelSettings()
                        } label: {
                            Text(String.localized("Settings", table: "Sidekick")).styleText(size: 13, weight: .regular, color: Color.S_0, align: .center)
                        }
                        .buttonStyle(PlainButtonStyle())
                    }
                }
