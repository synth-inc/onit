        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 16) {
                ...
                VStack(alignment: .leading, spacing: 12) {
                    Text(String.localized("Screenshots", table: "Sidekick"))
                        .font(.headline)
                ...
                VStack(alignment: .leading, spacing: 12) {
                    Text(String.localized("Text Comparison", table: "Sidekick"))
                        .font(.headline)
                ...
                // Export Section
                VStack(alignment: .leading, spacing: 12) {
                    Text(String.localized("Export Options", table: "Sidekick"))
                        .font(.headline)
                    ...
                    LazyVGrid(columns: Array(repeating: GridItem(.flexible()), count: 2), spacing: 8) {
                        ...
                        Button(String.localized("Export Comparison Report", table: "Sidekick")) {
                            exportComparison()
                        }
                        .buttonStyle(.bordered)
                        .font(.system(size: 12))
