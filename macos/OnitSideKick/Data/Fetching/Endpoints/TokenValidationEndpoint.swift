...
// Cerebras validation endpoint
struct CerebrasValidationEndpoint: Endpoint {
    var baseURL: URL = URL(string: "https://api.cerebras.ai")!

    typealias Request = Never
    typealias Response = CerebrasValidationResponse
...
struct CerebrasValidationResponse: Codable {
    let data: [Model]
