...
struct OnboardingSkipAccessibility: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 10) {
            ...
            Text(String.localized("Onit has been designed to work side-by-side with accessibility permission and relies on it for a lot of its features.", table: "Onboarding"))
            ...
            HStack {
                ...
                Button {
                    ...
                    Text(String.localized("Yes, continue →", table: "Onboarding"))
    ...
    private var header: some View {
        HStack(alignment: .top) {
            HStack(alignment: .top, spacing: 0) {
                Text(String.localized("Continue with\na limited experience?", table: "Onboarding"))
