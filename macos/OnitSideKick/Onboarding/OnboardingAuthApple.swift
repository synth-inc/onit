    ...
    ASAuthorizationControllerPresentationContextProviding
{
    ...
    private func handleAppleCredential(_ authorization: ASAuthorization) async throws {
        guard
            ...
            errorMessageAuth.wrappedValue = String.localized("Failed to get Apple identity token", table: "Onboarding")
            return
        }
    ...
    func presentationAnchor(for controller: ASAuthorizationController) -> ASPresentationAnchor {
        guard let window = NSApplication.shared.windows.first(
            ...
            errorMessageAuth.wrappedValue = String.localized("Unable to present Apple authentication dialog.", table: "Onboarding")
